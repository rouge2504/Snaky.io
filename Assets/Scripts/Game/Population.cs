  ...
  //  public List<Snake> allSnakes;
    ...
    IEnumerator SpawnSnakePopulation()
    {
       ...
       //     {
                ...
                {
                    SpawnSnake(Random.Range(25000, 35000), SnakeEnvironment.snakeType.superbig, "");  //10000
         ...
         //   }
            ...
            for (int i = 0; i < superbig; i++)
            {
                if (SnakeEnvironment.Singleton.CounterSnake < MaxPopulation)
                {
                    SpawnSnake(10000, SnakeEnvironment.snakeType.superbig, "");  //10000
                    yield return new WaitForSeconds(0.5f);
                }
            }
            ...
            for (int i = 0; i < reallybig; i++)
            {
                if (SnakeEnvironment.Singleton.CounterSnake < MaxPopulation)
                {
                    SpawnSnake(6000, SnakeEnvironment.snakeType.reallybig, "");
                    yield return new WaitForSeconds(0.5f);
                }
            }
            ...
            for (int i = 0; i < big; i++)
            {
                if (SnakeEnvironment.Singleton.CounterSnake < MaxPopulation)
                {
                    SpawnSnake(4000, SnakeEnvironment.snakeType.big, "");
                    yield return new WaitForSeconds(0.5f);
                }
            }
            ...
            for (int i = 0; i < medium; i++)
            {
                if (SnakeEnvironment.Singleton.CounterSnake < MaxPopulation)
                {
                    SpawnSnake(Random.Range(1000, 2000), SnakeEnvironment.snakeType.medium, "");
                    yield return new WaitForSeconds(0.5f);
                }
            }
        ...
        if (NsuperbigSnakes < superbigSnakes)
            ...
            switch (x)
            {
                case 0:
                        ...
                        if (SnakeEnvironment.Singleton.CounterSnake < MaxPopulation)
                        {
                            SpawnSnake(10000, SnakeEnvironment.snakeType.superbig, team);  //10000
                            return;
                        }
                ...
                case 1:
                        ...
                        if (SnakeEnvironment.Singleton.CounterSnake < MaxPopulation)
                        {
                            SpawnSnake(6000, SnakeEnvironment.snakeType.reallybig, team);  //10000
                            return;
                        }
                 ...
                 case 2:
                        ...
                        if (SnakeEnvironment.Singleton.CounterSnake < MaxPopulation)
                        {
                            SpawnSnake(4000, SnakeEnvironment.snakeType.big, team);  //10000
                            return;
                        }
